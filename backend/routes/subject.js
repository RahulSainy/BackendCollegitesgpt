...
router.post('/semester/:semester/branch/:branch/subjects',isAdminMiddleware, authMiddleware,  subjectController.createSubject);

// Update a specific subject
router.put('/semester/:semester/branch/:branch/subjects/:subject',isAdminMiddleware, authMiddleware,  subjectController.updateSubject);

// Delete a specific subject
router.delete('/semester/:semester/branch/:branch/subjects/:subject',isAdminMiddleware, authMiddleware,  subjectController.deleteSubject);
